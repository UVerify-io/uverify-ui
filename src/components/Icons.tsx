export const AddCardIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    aria-hidden="true"
...
export const LoadingIcon = ({ className }: { className?: string }) => (
  <svg
    aria-hidden="true"
    role="status"
    className={`inline w-4 h-4 me-3 drop-shadow-center-sm text-gray-200 animate-spin ${className}`}
    viewBox="0 0 100 101"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
...
export const FastBackwardIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export function getIcon(type: IconType) {
  switch (type) {
    ...
    case IconType.AngleDown:
      return AngleDown;
    case IconType.AngleUp:
      return AngleUp;
    case IconType.Copy:
      return Copy;
    case IconType.File:
      return FileIcon;
    case IconType.FastBackwardIcon:
      return FastBackwardIcon;
    case IconType.FastForwardIcon:
      return FastForwardIcon;
    case IconType.BackwardIcon:
      return BackwardIcon;
    case IconType.ForwardIcon:
      return ForwardIcon;
    case IconType.DiscordIcon:
      return DiscordIcon;
    ...
    case IconType.XIcon:
      return XIcon;
    case IconType.GitHubIcon:
      return GitHubIcon;
    case IconType.LinkedInIcon:
      return LinkedInIcon;
    case IconType.Eye:
      return EyeIcon;
  }
...
export enum IconType {
  ...
  Copy = 'copy',
  File = 'file',
  FastBackwardIcon = 'fast-backward',
